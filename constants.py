...
FASTTEXT_SENT_TRAIN_PATH = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'src/fastText/sentences.train')

# fastText sentences train file path
FASTTEXT_SENT_TEST_PATH = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'src/fastText/sentences.test')
